...
function country1(id) {
  console.log(orders.find(item => item.id === id).shipAddress.country);
}
country1(10823)
...
function object(country) {
  console.log(orders.find(item => item.shipAddress.country === country).shipAddress);
}
object("USA")
...
function cityCountryShipname(id) {
  console.log(orders.find(item => item.id== id).shipName);
  console.log(orders.find(item => item.id== id).shipAddress.country);
  console.log(orders.find(item => item.id== id).shipAddress.city);
}
cityCountryShipname(10823)
...
function sales(id) {
  console.log(orders.find(item => item.id === id).details.length);
}
sales(10823)
...
function getTotalRevenueWithDiscount(id) {
  ...
  if (order) {
    ...
    order.details.forEach(detail => {
      const discountedPrice = detail.unitPrice * (1 - detail.discount);
      totalRevenue += discountedPrice * detail.quantity;
    });
...
const orderId = 11055;
const totalRevenue = getTotalRevenueWithDiscount(orderId);
console.log("Total Profit" + ":", totalRevenue);